...
func TestEventCreationSnapshotsAllUsers(t *testing.T) {
	...
	a.findOrCreateUser(ctx, "bob@id5.io", "Bob", "Jones", "")
	a.findOrCreateUser(ctx, "carol@id5.io", "Carol", "Smith", "")
...
func TestNewUserAddedToOpenEventsOnly(t *testing.T) {
	...
	bob, err := a.findOrCreateUser(ctx, "bob@id5.io", "Bob", "Jones", "")
	if err != nil {
...
func TestRemovedAttendeeStaysRemoved(t *testing.T) {
	...
	ctx := context.Background()
	admin, _ := a.findOrCreateUser(ctx, "admin@id5.io", "Admin", "", "")
	bob, _ := a.findOrCreateUser(ctx, "bob@id5.io", "Bob", "Jones", "")
	id := mkEventForTest(t, a, ctx, admin.ID, "offsite", "2099-10-12", "2099-10-16")
